...
class SpeechDataset(data.Dataset):
    ...
    def default_config():
        ...
        # config["data_folder"] = "/home/guyue/CNNProgram/CNNTest"
        # config["data_folder"] = "/home/guyue/CNNProgram/speech_commands_v0.02_snr_-3_6"
        # config["data_folder"] = "/home/guyue/CNNProgram/CNNnoise"
        # config["data_folder"] = "/home/guyue/CNNProgram/speech_commands_v0.02_new"
        config["data_folder"] = "/home/guyue/CNNProgram/speech_commands_v0.02_snr_-3_6"
        return config
...
_configs = {
    ...
    ConfigType.CNN_ONE_STRIDE1.value: dict(dropout_prob=0.5, height=101, width=40, n_labels=4, n_feature_maps1=186,
                                           conv1_size=(101, 8), conv1_pool=(1, 1), conv1_stride=(1, 1), dnn1_size=128,
                                           dnn2_size=128, tf_variant=True),
    ConfigType.CNN_TSTRIDE2.value: dict(dropout_prob=0.5, height=101, width=40, n_labels=4, n_feature_maps1=78,
                                        n_feature_maps2=78, conv1_size=(16, 8), conv2_size=(9, 4), conv1_pool=(1, 3),
                                        conv1_stride=(2, 1),
    ...
    ConfigType.CNN_TSTRIDE4.value: dict(dropout_prob=0.5, height=101, width=40, n_labels=4, n_feature_maps1=100,
                                        n_feature_maps2=78, conv1_size=(16, 8), conv2_size=(5, 4), conv1_pool=(1, 3),
                                        conv1_stride=(4, 1),
                                        conv2_stride=(1, 1), conv2_pool=(1, 1), dnn1_size=128, dnn2_size=128),
