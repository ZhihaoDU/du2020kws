...
if __name__ == '__main__':
    ...
    MODEL_NAME = "jointtraining_vtest"
    BATCH_SIZE = 512
    TIME_STEPS = 1000
    FEAT_LENGTH = 320
   ...
   #test
    DT05_NOISE_LIST = "/home/guyue/CNNProgram/datalist/enhanced_into_baseline/snr-1_unmatch_keyword_test.lst"
    DT05_CLEA_LIST =  "/home/guyue/CNNProgram/datalist/enhanced_into_baseline/mapping_pure_snr-1_unmatch_keyword_test.lst"
   # DT05_NOISE_LIST = "/home/guyue/CNNProgram/datalist/enhancement/mixed_keyword_dev.lst"
    ...
    #DT05_NOISE_LIST = "/home/guyue/CNNProgram/datalist/baseline/pure_test.lst"
    #DT05_CLEA_LIST = "/home/guyue/CNNProgram/datalist/baseline/pure_test.lst"
    ...
    # enhancer
    #model=torch.load("/home/guyue/nfs_212/myEnhancement/fft_masking_bilstm_adjusted_2/epoch_45.pkl")
    ...
    tr_global_step = 0
    dt_global_step = 0
    mel_basis = torch.tensor(np.load("/home/guyue/joint_training/joint_model/mel_basis/epoch_1.npy")).cuda()
    dct_filters = torch.tensor(np.load("/home/guyue/joint_training/joint_model/dct_filters/epoch_1.npy")).cuda()
    ...
    if mode == 'train':
        ...
        mel_basis = torch.tensor(np.load("/home/guyue/joint_training/joint_model/mel_basis/epoch_1.npy"))
        #mel_basis.requires_grad=True
        #dct_filters = torch.tensor(librosa.filters.dct(40, 40)).to('cuda:0')
        dct_filters = torch.tensor(np.load("/home/guyue/joint_training/joint_model/dct_filters/epoch_1.npy"))
        #dct_filters.requires_grad=True
        ...
        with torch.no_grad():
            ...
            my_wb.save('/home/guyue/kws_result/kws_result.xlsx')
